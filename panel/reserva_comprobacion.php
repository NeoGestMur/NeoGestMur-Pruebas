...
$personal = mysqli_query($rural, $query_personal) or die(mysqli_error());
...
?>      
	...
	<tr valign="baseline">
      <td nowrap="nowrap" align="right">N&ordm;:</td>
    ...
    <tr valign="baseline">
      ...
      <td><textarea name="observaciones" cols="45" rows="5" disabled="disabled" readonly="readonly"><?php echo htmlentities($row_reserva['observaciones'], ENT_COMPAT, 'iso-8859-1'); ?></textarea></td>
...
?>
    <tr valign="baseline">
      ...
      <td nowrap="nowrap" align="right">Precio d&iacute;a semana:</td>
    ...
    <tr valign="baseline">
      ...
      <td nowrap="nowrap" align="right">Precio d&iacute;a festivo:</td>
    ...
    <tr valign="baseline">
      ...
      <td nowrap="nowrap" align="right">N&ordm; d&iacute;as festivos:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Sof&aacute; cama:</td>
      <td><label>
    ...
    <tr valign="baseline">
      ...
      <td><input name="cuna" type="text" disabled="disabled" id="cuna" value="<?php echo htmlentities($row_reserva['animales'], ENT_COMPAT, 'iso-8859-1'); ?>" size="10" readonly="readonly" /> 
        &euro;</td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
	  ...
	  $total_s = $total_d + $s_s + $s_c + $s_cu + $row_reserva['precio_extras']+$row_reserva['animales'];
	  echo $total_s;?> &euro;
      </td>
    </tr>
    ...
    <tr valign="baseline">
      ...
      <td colspan="2" align="center" nowrap="nowrap">
      	<div class="bton_nuevo"><a href="reserva_nueva.php?id_cliente=<?php echo $row_reserva['id_ref']; ?>">Crear otra reserva</a></div>  
