...
function calendario ($year,$mes,$finDeSemana=1,$nivelH=2, $idc, $database_rural,$rural) {
	...
	*/
		...
		//$html .= '<li class="anterior"><a href="?mes='.$mesAnterior.'&amp;ano='.$yearMesAnterior.'&amp;id_casa='.$idc.'"><span>Mes anterior ('.$meses[($mesAnterior-1)].')</span></a></li>';
		//$html .= '<li class="siguiente"><a href="?mes='.$mesSiguiente.'&amp;ano='.$yearMesSiguiente.'&amp;id_casa='.$idc.'"><span>Mes siguiente ('.$meses[($mesSiguiente-1)].')</span></a></li>';
		//$html .= '</ul>';
		...
		//$html .= '<li class="anterior"><a href="?mes='.$mes.'&amp;ano='.$yearAnterior.'&amp;id_casa='.$idc.'"><span>A&ntilde;o anterior (</span>'.$yearAnterior.'<span>)</span></a></li>';
		//$html .= '<li class="siguiente"><a href="?mes='.$mes.'&amp;ano='.$yearSiguiente.'&amp;id_casa='.$idc.'"><span>A&ntilde;o siguiente (</span>'.$yearSiguiente.'<span>)</span></a></li>';
		//$html .= '</ul>';
